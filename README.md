...
python render_hierarchy.py -s ${DATASET_DIR} --model_path ${model_path}/output --hierarchy ${hierarchy_dir}/output/merged.hier --out_dir ${DATASET_DIR}/output/renders --eval --scaffold_file ${DATASET_DIR}/output/scaffold/point_cloud/iteration_30000
```
